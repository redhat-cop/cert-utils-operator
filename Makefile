...
REGISTRY ?= quay.io
REPOSITORY ?= $(REGISTRY)/redhat-cop/cert-utils-operator
...
LDFLAGS := "-X github.com/redhat-cop/cert-utils-operator/version.Version=$(VERSION) \
	...
	-X github.com/redhat-cop/cert-utils-operator/version.Timestamp=$(BUILD_TIMESTAMP) \
	-X github.com/redhat-cop/cert-utils-operator/version.Hostname=$(BUILD_HOSTNAME)"
